...
char ssid[] = "I hate iot";
char pass[] = "anyaforger";
// Ensure that the credentials here allow you to publish and subscribe to the ThingSpeak channel.
#define channelID 2509815
const char mqttUserName[] = "DRUVNS0GDSM5MDAPJxUiCBM"; 
const char clientID[] = "DRUVNS0GDSM5MDAPJxUiCBM";
const char mqttPass[] = "SnUdTJwruV5Kd5nAil9DOiEx";
